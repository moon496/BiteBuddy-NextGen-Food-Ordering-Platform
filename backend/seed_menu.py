...
INITIAL_MENU = [
    {"name": "Burger", "price": 120, "category": "Fast Food", "image": "https://images.unsplash.com/photo-1571091718767-18b5b1457add?q=80&w=500"},
    ...
    {"name": "Double Cheeseburger", "price": 320, "category": "Burgers", "image": "https://images.unsplash.com/photo-1572802419224-296b0aeee0d9?q=80&w=500"},
...
def seed():
    ...
    try:
        if db.query(MenuItem).first():
            ...
            return
        for data in INITIAL_MENU:
            db.add(MenuItem(**data))
        db.commit()
        print(f"Seeded {len(INITIAL_MENU)} menu items.")
    finally:
        db.close()
